...
public class BookResource {
    ...
    public Response getById(@PathParam("id") long id) {
        // TODO 6: Vereinfache — Service wirft jetzt Exception bei nicht-gefunden
    ...
    public Response update(@PathParam("id") long id, @Valid Book book) {
        // TODO 7: Vereinfache — Service wirft jetzt Exception bei nicht-gefunden
    ...
    public Response delete(@PathParam("id") long id) {
        // TODO 8: Vereinfache — Service wirft jetzt Exception bei nicht-gefunden
